...
% ─── Additional theorem environment not in di-base ──────────────────────────
\theoremstyle{plain}
...
% Local, paper-specific bibliography (active by default).
...
% coauthors may prefer to keep this paper's references self-contained, or
